...
public class Homepage extends JFrame {
	...
	public Homepage() {
		...
		//addbookicon.setIcon(new ImageIcon(Homepage.class.getResource("/image/addadmin.png")));
		...
		label = new JLabel("");
		//label.setIcon(new ImageIcon(Homepage.class.getResource("/image/deletemember.png")));
		label.setHorizontalAlignment(SwingConstants.CENTER);
		label.setBounds(37, 465, 26, 26);
		panel.add(label);
		
		label_1 = new JLabel("");
		//label_1.setIcon(new ImageIcon(Homepage.class.getResource("/image/bookrecords.png")));
		label_1.setHorizontalAlignment(SwingConstants.CENTER);
		label_1.setBounds(37, 365, 26, 26);
		panel.add(label_1);
		
		label_2 = new JLabel("");
		//label_2.setIcon(new ImageIcon(Homepage.class.getResource("/image/studentrecords.png")));
		label_2.setHorizontalAlignment(SwingConstants.CENTER);
		label_2.setBounds(37, 315, 26, 26);
		panel.add(label_2);
		
		label_3 = new JLabel("");
		//label_3.setIcon(new ImageIcon(Homepage.class.getResource("/image/deletebook.png")));
		label_3.setHorizontalAlignment(SwingConstants.CENTER);
		label_3.setBounds(37, 215, 26, 26);
		panel.add(label_3);
		
		label_4 = new JLabel("");
		//label_4.setIcon(new ImageIcon(Homepage.class.getResource("/image/issue.png")));
		label_4.setHorizontalAlignment(SwingConstants.CENTER);
		label_4.setBounds(37, 265, 26, 26);
		panel.add(label_4);
		
		label_5 = new JLabel("");
		//label_5.setIcon(new ImageIcon(Homepage.class.getResource("/image/settings.png")));
		label_5.setHorizontalAlignment(SwingConstants.CENTER);
		label_5.setBounds(37, 515, 26, 26);
		panel.add(label_5);
		
		JLabel label_6 = new JLabel("");
		//label_6.setIcon(new ImageIcon(Homepage.class.getResource("/image/addbook.png")));
		label_6.setHorizontalAlignment(SwingConstants.CENTER);
		label_6.setBounds(37, 163, 26, 26);
		panel.add(label_6);
		
		JLabel label_7 = new JLabel("");
		//label_7.setIcon(new ImageIcon(Homepage.class.getResource("/image/logoutadmin.png")));
	...
	public void showTableBook1() {
		try{
		String sql= "select * from book_info where b_id=? and b_name like CONCAT ('%',?,'%')";
